...
class ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   children: [
      //     appBarTitle(
      //         title: CUR_USERNAME != "" ? CUR_USERNAME : "Desi Diaries"),
      //     Positioned(
  ...
  _showContent() {
    return SingleChildScrollView(
        ...
        padding: EdgeInsetsDirectional.only(
            ...
            start: 15.0, end: 15.0, top: 15.0, bottom: 10.0),
        child: Column(
